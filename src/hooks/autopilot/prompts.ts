...
Save to: \`.brainless/autopilot/spec.md\`
...
Save to: .brainless/plans/autopilot-impl.md
...
\`\`\`
Task(
  subagent_type="brainless:critic",
  model="opus",
  prompt="REVIEW IMPLEMENTATION PLAN

Plan file: .brainless/plans/autopilot-impl.md
...
Task(subagent_type="brainless:executor-low", model="haiku", prompt="...")
...
Task(subagent_type="brainless:executor-high", model="opus", prompt="...")
\`\`\`
...
\`\`\`
Task(
  subagent_type="brainless:architect-low",
  model="haiku",
...
\`\`\`
Task(
  subagent_type="brainless:build-fixer",
  model="sonnet",
...
// Security Review
Task(
  subagent_type="brainless:security-reviewer",
  model="opus",
...
// Code Quality Review
Task(
  subagent_type="brainless:code-reviewer",
  model="opus",
...
export function getPhasePrompt(
  ...
  switch (phase) {
    ...
    case 'planning':
      return getDirectPlanningPrompt(context.specPath || '.brainless/autopilot/spec.md');
    case 'execution':
      return getExecutionPrompt(context.planPath || '.brainless/plans/autopilot-impl.md');
    case 'qa':
      return getQAPrompt();
    case 'validation':
      return getValidationPrompt(context.specPath || '.brainless/autopilot/spec.md');
    default:
      return '';
  }
}
