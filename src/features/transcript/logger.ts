 ...
 */
export function getTranscriptDir(workingDir?: string): string {
 ...
 */
export function getActivityLogPath(workingDir?: string): string {
 ...
 */
export function getDecisionsPath(workingDir?: string): string {
 ...
 */
export function ensureTranscriptDirs(workingDir?: string): void {
...
export function getActivities(
  ...
  const activities: AgentActivity[] = lines.map(line => {
    try {
      return JSON.parse(line) as AgentActivity;
    } catch {
      return null;
    }
 ...
 * Get all decisions
 */
export function getDecisions(workingDir?: string): Decision[] {
  const logPath = getDecisionsPath(workingDir);
 ...
 */
export function saveDebateRoom(room: DebateRoom, workingDir?: string): void {
  const debatesDir = getDebatesDir(workingDir);
 ...
 * Load a debate room
 */
export function loadDebateRoom(debateId: string, workingDir?: string): DebateRoom | null {
 ...
 */
export function clearTranscript(workingDir?: string): void {
