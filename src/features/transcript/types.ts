...
export type AgentAction =
  | 'spawned'        // Agent was invoked
  | 'completed'      // Agent finished successfully
  | 'failed'         // Agent encountered error
  | 'delegated'      // Agent spawned another agent
  | 'proposed'       // Agent made a proposal (for debate)
  | 'approved'       // PM approved a decision
  | 'rejected'       // PM rejected, requested revision
  | 'debated'        // Agents discussed a topic
  | 'decided'        // PM made a decision
  | 'gate_pending'   // Waiting for approval gate
  | 'gate_passed';   // Approval gate passed
...
export type DebateMessageType =
  ...
  | 'support'     // Supporting the proposal
  | 'question'    // Asking for clarification
  | 'clarify'     // Clarifying a point
  | 'decision';   // Final decision by moderator
...
export const DEFAULT_TRANSCRIPT_CONFIG: TranscriptConfig = {
  ...
  transcript_dir: '.brainless/transcripts',
