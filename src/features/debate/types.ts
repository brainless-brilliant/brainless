...
export type DebateMessageType =
  ...
  | 'clarify'       // Providing clarification
  | 'concern'       // Raising a concern (cross-cutting issue)
  | 'acknowledge'   // Acknowledging a point
...
export type DebateStatus = 
  ...
  | 'resolved'      // PM made decision
  | 'consensus'     // Agents reached agreement
  | 'escalated'     // Needs user input
  | 'abandoned';    // Debate cancelled
