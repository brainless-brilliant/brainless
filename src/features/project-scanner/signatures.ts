 ...
 */
export function getSignaturesByCategory(category: string): TechnologySignature[] {
 ...
 */
export function getSignatureByName(name: string): TechnologySignature | undefined {
 ...
 */
export function extendSignatures(signatures: TechnologySignature[]): TechnologySignature[] {
