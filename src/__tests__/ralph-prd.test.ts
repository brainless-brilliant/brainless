...
describe('Ralph PRD Module', () => {
  ...
  describe('findPrdPath', () => {
    ...
    it('should find prd.json in .anv directory', () => {
      const omcDir = join(testDir, '.anv');
    ...
    it('should prefer root over .anv', () => {
  ...
  describe('readPrd / writePrd', () => {
    ...
    it('should create .anv directory when writing', () => {
      writePrd(testDir, samplePrd);
      expect(existsSync(join(testDir, '.anv'))).toBe(true);
    });
  ...
  describe('markStoryComplete / markStoryIncomplete', () => {
    ...
    it('should return false when no prd exists', () => {
      rmSync(join(testDir, '.anv'), { recursive: true, force: true });
