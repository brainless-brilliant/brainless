...
describe('Skill Finder', () => {
  ...
  beforeEach(() => {
    ...
    mkdirSync(join(projectRoot, '.anv', 'skills'), { recursive: true });
  });
  ...
  it('should find project-level skills', () => {
    const skillPath = join(projectRoot, '.anv', 'skills', 'test-skill.md');
  ...
  it('should prioritize project skills over user skills', () => {
    ...
    const projectSkillPath = join(projectRoot, '.anv', 'skills', 'skill.md');
  ...
  it('should get skills directory for project scope', () => {
    ...
    expect(projectDir).toContain('.anv');
