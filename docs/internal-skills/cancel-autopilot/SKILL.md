...
Run `/anveekshacode:autopilot` to resume from where you left off.
...
```
/anveekshacode:cancel-autopilot --clear
```

This removes all autopilot files including:
- `.brainless/autopilot-state.json`
- `.brainless/autopilot/` directory
- `.brainless/plans/autopilot-impl.md`
