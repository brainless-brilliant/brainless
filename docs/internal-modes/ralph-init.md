...
Create `.brainless/prd.json` and `.brainless/progress.txt` based on the task description.
...
After creating files, report summary and suggest running `/anveekshacode:ralph-loop` to start.
