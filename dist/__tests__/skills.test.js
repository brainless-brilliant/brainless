...
describe('Builtin Skills', () => {
    ...
    describe('createBuiltinSkills()', () => {
        it('should return correct number of skills (41)', () => {
            ...
            // 41 skills: analyze, autopilot, build-fix, cancel, cancel-autopilot, cancel-ecomode, cancel-ralph, cancel-ultraqa, cancel-ultrawork,
            // code-review, deepinit, deepsearch, default, default-global, doctor, ecomode, frontend-ui-ux, git-master, help, hud, learner, mcp-setup, note,
            // orchestrate, pipeline, plan, planner, provision, ralph, ralph-init,
            // ralplan, release, research, review, security-review, setup, swarm, tdd, ultrapilot, ultraqa, ultrawork
    ...
    describe('listBuiltinSkillNames()', () => {
        it('should return all skill names', () => {
            ...
            expect(names).toContain('default-global');
