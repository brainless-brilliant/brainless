...
describe('delegation-enforcer integration', () => {
    ...
    describe('pre-tool-use hook with Task calls', () => {
        ...
        it('does not log warning when AVK_DEBUG not set', async () => {
            delete process.env.AVK_DEBUG;
        ...
        it('logs warning when AVK_DEBUG=true', async () => {
            ...
            await processHook('pre-tool-use', input);
            expect(consoleWarnSpy).toHaveBeenCalledWith(expect.stringContaining('[AVK] Auto-injecting model'));
