...
describe('Ralph Progress Module', () => {
    ...
    describe('initProgress', () => {
        it('should create progress.txt in .anv directory', () => {
            expect(initProgress(testDir)).toBe(true);
            expect(existsSync(join(testDir, '.anv', PROGRESS_FILENAME))).toBe(true);
        });
    ...
    describe('readProgressRaw / readProgress', () => {
        ...
        it('should read progress from .anv directory', () => {
