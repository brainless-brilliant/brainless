 ...
 * By Brainless Technologies Pvt. Ltd.
 *
 * Main features:
 * - Workforce Orchestrator: Primary coordinator that delegates to specialized subagents
 ...
 * - Workforce Provisioning: Intelligent tech-stack detection and agent recommendation
 */
...
/**
 * Options for creating a Workforce session
 */
 ...
 * ```
 */
export declare function createWorkforceSession(options?: WorkforceOptions): WorkforceSession;
/** @deprecated Use createWorkforceSession instead */
export declare const createBrainlessSession: typeof createWorkforceSession;
/**
