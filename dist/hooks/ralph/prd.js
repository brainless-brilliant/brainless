...
/**
 * Get the path to the prd.json in .anv subdirectory
 */
export function getOmcPrdPath(directory) {
    return join(directory, '.anv', PRD_FILENAME);
}
/**
 * Find prd.json in a directory (checks both root and .anv)
 */
...
export function writePrd(directory, prd) {
    // Prefer writing to existing location, or .anv by default
