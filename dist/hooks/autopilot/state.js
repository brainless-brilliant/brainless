 ...
 */
function ensureOmcDir(directory) {
    const omcDir = join(directory, '.anv');
...
export function ensureAutopilotDir(directory) {
    ...
    const autopilotDir = join(directory, '.anv', SPEC_DIR);
...
export function getSpecPath(directory) {
    return join(directory, '.anv', SPEC_DIR, 'spec.md');
}
/**
 * Get the plan file path
 */
export function getPlanPath(directory) {
    return join(directory, '.anv', 'plans', 'autopilot-impl.md');
}
/**
