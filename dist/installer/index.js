...
export const VERSION_FILE = join(CLAUDE_CONFIG_DIR, '.brainless-version.json');
/**
    ...
    try {
        ...
        if (!runningAsPlugin) {
            ...
            try {
                ...
                const mergeResult = await performCLAUDEmdMerge(pluginClaudeMd, claudeMdPath, { verbose: options.verbose || false });
        ...
        try {
            ...
            const hudScriptLines = [
                ...
                '  const devPaths = [',
                '    join(home, "Workspace/brainlesscode/dist/hud/index.js"),',
                '    join(home, "workspace/brainlesscode/dist/hud/index.js"),',
                '    join(home, "projects/brainlesscode/dist/hud/index.js"),',
                '  ];',
                '  ',
                ...
                '  const pluginCacheBase = join(home, ".claude/plugins/cache/omc/brainlesscode");',
                ...
                '  try {',
                '    await import("brainless/dist/hud/index.js");',
                '    return;',
                '  } catch { /* continue */ }',
                '  ',
                '  // 4. Fallback: suggest setup',
                '  console.log("[AVK] run /omc-setup to install properly");',
                '}',
                '',
                'main();',
            ];
