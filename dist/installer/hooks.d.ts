...
export declare const KEYWORD_DETECTOR_SCRIPT: string;
/** Stop continuation hook script - loaded from templates/hooks/stop-continuation.sh */
export declare const STOP_CONTINUATION_SCRIPT: string;
...
export declare const PERSISTENT_MODE_SCRIPT: string;
/** Session start Bash script - loaded from templates/hooks/session-start.sh */
export declare const SESSION_START_SCRIPT: string;
...
export declare const POST_TOOL_USE_SCRIPT: string;
 ...
 */
export declare function getHookScriptsBash(): Record<string, string>;
/**
 * Get Node.js hook scripts (Cross-platform)
 * Returns a record of filename -> content for all Node.js hooks
 */
export declare function getHookScriptsNode(): Record<string, string>;
/**
