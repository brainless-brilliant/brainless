...
// Project Scanner - technology detection and analysis
export { 
// Scanner functions
scanProject, formatScanSummary, hasTechnology, getTechnologiesByCategory, 
// Signatures
TECHNOLOGY_SIGNATURES, getSignaturesByCategory, getSignatureByName, extendSignatures, } from './project-scanner/index.js';
// Team Assembler - intelligent agent team composition
export { 
// Assembler functions
assembleTeam, quickAssemble, formatResourceSheet, getTeamForTask, 
// Registry
AGENT_REGISTRY, TECH_TO_AGENT_MAPPINGS, getAgentMetadata, getAgentsByCapability, getAgentsForTechnology, getSkillsForTechnology, } from './team-assembler/index.js';
// Transcript - agent activity logging and audit trail
export { DEFAULT_TRANSCRIPT_CONFIG, 
// Logging functions
logActivity, getActivities, getRecentActivities, logDecision, getDecisions, 
// Formatting
getTranscriptSummary, formatTranscript, formatTimeline, clearTranscript, 
// Utilities
getTranscriptDir, ensureTranscriptDirs, } from './transcript/index.js';
// Orchestration - PM-managed team execution with phases and gates
export { PHASE_TRANSITIONS, PHASE_AGENTS, DEFAULT_ORCHESTRATION_CONFIG, 
// State management
createOrchestration, loadOrchestration, getActiveOrchestration, saveOrchestration, 
// Phase transitions
...
failOrchestration, 
// Display
getOrchestrationSummary, formatOrchestrationStatus, } from './orchestration/index.js';
// Debate - inter-agent communication and cross-cutting concerns
export { DEFAULT_DEBATE_CONFIG, 
// Debate lifecycle
createDebate, loadDebate, listDebates, 
// Messages
addMessage, addProposal, addCounter, 
// Concerns
raiseConcern, resolveConcern, getActiveConcerns, getBlockers, 
// Resolution
advanceRound, resolveDebate, formatDebate, } from './debate/index.js';
