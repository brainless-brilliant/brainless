...
function selectAgentType(component) {
    const roleToAgent = {
        frontend: 'brainless:designer',
        backend: 'brainless:executor',
        database: 'brainless:executor',
        api: 'brainless:executor',
        ui: 'brainless:designer',
        shared: 'brainless:executor',
        coordinator: 'brainless:architect',
        testing: 'brainless:qa-tester',
        docs: 'brainless:writer',
        config: 'brainless:executor',
        module: 'brainless:executor'
    };
    return roleToAgent[component.role] || 'brainless:executor';
}
