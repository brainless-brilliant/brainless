...
import { PHASE_TRANSITIONS, PHASE_AGENTS } from './types.js';
import { logActivity, logDecision } from '../transcript/index.js';
/**
 * Get orchestration state directory
 */
export function getOrchestrationDir(workingDir) {
 ...
 */
export function generateOrchestrationId() {
 ...
 */
export function createOrchestration(task, sessionId, workingDir, config = {}) {
 ...
 */
export function saveOrchestration(state, workingDir) {
    ensureOrchestrationDir(workingDir);
 ...
 */
export function loadOrchestration(orchestrationId, workingDir) {
 ...
 */
export function setActiveOrchestration(orchestrationId, workingDir) {
    ensureOrchestrationDir(workingDir);
 ...
 */
export function getActiveOrchestration(workingDir) {
    const path = getActiveOrchestrationPath(workingDir);
    if (!existsSync(path)) {
        return null;
    }
 ...
 */
export function clearActiveOrchestration(workingDir) {
    const path = getActiveOrchestrationPath(workingDir);
    if (existsSync(path)) {
 ...
 */
export function transitionPhase(orchestrationId, targetPhase, workingDir) {
 ...
 */
export function createGate(orchestrationId, targetPhase, proposalSummary, requiresApprovalFrom = 'pm', artifactPath, workingDir) {
    const state = loadOrchestration(orchestrationId, workingDir);
    if (!state) {
        return null;
    }
 ...
 * Approve a gate
 */
export function approveGate(orchestrationId, gateId, approvedBy = 'pm', workingDir) {
    const state = loadOrchestration(orchestrationId, workingDir);
    if (!state) {
        return null;
    }
 ...
 * Reject a gate
 */
export function rejectGate(orchestrationId, gateId, feedback, rejectedBy = 'pm', workingDir) {
    const state = loadOrchestration(orchestrationId, workingDir);
    if (!state) {
        return null;
    }
 ...
 * Record a decision
 */
export function recordDecision(orchestrationId, topic, options, chosen, rationale, madeBy = 'pm', debateId, workingDir) {
    const state = loadOrchestration(orchestrationId, workingDir);
    if (!state) {
        return null;
    }
 ...
 * Fail orchestration
 */
export function failOrchestration(orchestrationId, reason, workingDir) {
    const state = loadOrchestration(orchestrationId, workingDir);
    if (!state) {
        return null;
    }
 ...
 */
export function getOrchestrationSummary(orchestrationId, workingDir) {
    const state = loadOrchestration(orchestrationId, workingDir);
    if (!state) {
        return null;
    }
 ...
 */
export function formatOrchestrationStatus(orchestrationId, workingDir) {
