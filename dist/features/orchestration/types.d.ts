 ...
 */
export type OrchestrationPhase = 'initialized' | 'analyzing' | 'designing' | 'reviewing_design' | 'planning' | 'reviewing_plan' | 'executing' | 'verifying' | 'completed' | 'failed' | 'paused';
/**
 ...
 */
export declare const PHASE_TRANSITIONS: Record<OrchestrationPhase, OrchestrationPhase[]>;
/**
 * Agents typically involved in each phase
 */
export declare const PHASE_AGENTS: Record<OrchestrationPhase, string[]>;
/**
