...
function loadSkillFromFile(skillPath, skillName) {
    try {
        ...
        // Parse injectAsContext as boolean
        const injectAsContext = data['inject-as-context']?.toLowerCase() === 'true' ||
            data['injectAsContext']?.toLowerCase() === 'true';
        return {
