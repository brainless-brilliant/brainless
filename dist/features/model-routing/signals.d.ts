 ...
 */
export declare function extractTaskCapabilities(signals: ComplexitySignals): TaskCapabilities;
/**
 ...
 */
export declare function extractTaskCapabilitiesAsync(signals: ComplexitySignals, taskPrompt: string): Promise<{
