 ...
 */
export declare function routeTaskAsync(context: RoutingContext, config?: Partial<RoutingConfig>): Promise<RoutingDecision & {
    classificationSource?: 'haiku' | 'keyword' | 'cache';
}>;
/**
