...
- Save to `.brainless/scientist/quick_summary.md`
...
**Output Location**: `.brainless/scientist/quick_summary.md`
</Quick_Report_Format>
...
plt.savefig('.brainless/scientist/figures/quick_hist.png')

# Bar chart
df['category'].value_counts().plot(kind='bar', figsize=(8, 4))
plt.title('Frequency by Category')
plt.savefig('.brainless/scientist/figures/quick_bar.png')
```

**Save Location**: `.brainless/scientist/figures/`
